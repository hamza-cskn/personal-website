<script>
    ...
    let projects = [
        ...
        },
        {
            ...
            technologies: "HTML, CSS, JavaScript, Node.js, Svelte, AWS, and GitHub Actions",
            link: "#",
        },
        {
        ...
        },
        {
            ...
            desc: "École 42 student projects. Generally contains implementations of unix commands.",
            technologies: "C, Linux and Shell",
            link: "https://github.com/hamza-cskn/42-cursus",
        },
        {
        ...
        <li>
            ...
            <div data-popover id={"popover-default" + project.title} role="tooltip"
                ...
                <div class="px-3 py-2 bg-gray-100 border-b border-gray-200 rounded-t-lg dark:border-gray-600 dark:bg-gray-700">
                    ...
                    {#if project.archived}
                        <p class="font-italic text-red-400">archived</p>
                    {/if}
                </div>
                <div class="px-3 py-2">
                    <p>{project.desc}</p>
